...
async function loadProfile() {
    ...
    try {
        ...
        const res = await fetch(`https://bus-booking-system-94pd.onrender.com/api/profile/bookings/${user._id}`);
...
async function cancelBooking(id) {
    ...
    try {
        const res = await fetch(`https://bus-booking-system-94pd.onrender.com/api/bookings/cancel/${id}`, {
            method: "DELETE"
        });
